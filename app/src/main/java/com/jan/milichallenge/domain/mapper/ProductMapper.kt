...
import com.jan.milichallenge.config.ProductResponse
import com.jan.milichallenge.config.ProductRoom
import com.jan.milichallenge.domain.model.Product
...
fun Product.toProductRoom() = ProductRoom(
    ...
    permalink = this.permalink,
    price = this.price,
    seller = this.seller.toSellerRoom(),
    sellerAddress = this.sellerAddress.toSellerAddressRoom(),
    siteId = this.siteId,
    soldQuantity = this.soldQuantity,
    stopTime = this.stopTime,
    tags = this.tags,
